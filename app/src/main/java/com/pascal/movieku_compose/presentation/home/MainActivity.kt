...
import com.pascal.movieku_compose.presentation.detail.DetailScreen
...
import com.pascal.movieku_compose.utils.Routes
...
@Composable
fun MainScreen(viewModelInstance: MainViewModel = hiltViewModel(), onMovieClicked: (Int) -> Unit) {

    var selection: Int by rememberSaveable { mutableIntStateOf(0) }
                ...
                actions = {
                    Row(modifier = Modifier.padding(all = 0.dp)) {
                        IconButton(onClick = {
                            ...
                            ActionIcon(
                                vectorDrawable = ImageVector.vectorResource(id = R.drawable.ic_most_popular_svg),
                                description = "popular",
                                tint = getActionIconColor(selection == 0)
                            )
                        }
                        IconButton(onClick = {
                            selection = 1
                            ...
                            ActionIcon(
                                vectorDrawable = ImageVector.vectorResource(id = R.drawable.ic_top_rated_svg),
                                description = "top",
                                tint = getActionIconColor(selection == 1)
                            )
                        }
                        IconButton(onClick = {
                            selection = 2
                            ...
                            ActionIcon(
                                vectorDrawable = Icons.Outlined.FavoriteBorder,
                                description = "fav",
                                tint = getActionIconColor(selection == 2)
                            )
                        }
                    }
                },
